...
class PemissionDeletePegawai implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if ($token) {
            try {
                ...
                if (!in_array("delete.pegawai", $permission)) {
                    return response()->setJSON(['message' => "Anda tidak punya akses menghapus data pegawai"])->setStatusCode(400);
                }
