...
class PemissionGetAllPegawai implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if ($token) {
            try {
                ...
                if (!in_array("read.pegawai", $permission)) {
                    return response()->setJSON(['message' => "Anda tidak punya akses melihat data pegawai"])->setStatusCode(403);
                }
