...
class PemissionUpdatePegawai implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if ($token) {
            try {
                ...
                if (!in_array("update.pegawai", $permission)) {
                    return response()->setJSON(['message' => "Anda tidak punya akses update data pegawai"])->setStatusCode(400);
                }
